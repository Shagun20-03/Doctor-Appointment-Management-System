...
<body >
	<div class="header">
		<ul>
			...
			<li><a href="mlogin.php">Home</a></li>
		</ul>
	</div>
	...
	<div>
		...
		<label style="font-size:20px"><b style="color:black">Doctor:</b></label><br>
		...
		<label><b style="color:black">Date:</b></label><br>
...
require_once("dbconfig.php");
			if(isset($_POST['submit2']))
		{
			...
			{	
				...
				{
							echo "<br>$fnm[$j] :Status updated successfully..!!";
