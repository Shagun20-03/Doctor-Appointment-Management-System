...
<section class="main">
  ...
  background-color: #2B4F76;">
					<li style="float:left;border-right:none"><a href="cover.php" >Doctor Appointment Booking System</a></li>
					<li><a href="locateus.php">Locate Us</a></li>
					<li><a href="#home">Home</a></li>
				</ul>
			</div>
			<div class="center">
				<h1 style="cursive"> Welcome to</h1>
				<p style="text-align:center;color:#2B4F76;font-size:30px;top:54%">Online Appointment Booking System</p><br>
				
				<button  onclick="document.getElementById('id01').style.display='block'" style="position:absolute;top:46%;left:44%"> User Login</button>
				
			</div>	
			<div class="footer">
				<ul style="position:absolute;top:85%; list-style-type: none;
  margin: 0;
  padding: 0;
  overflow: hidden;
  background-color: #2B4F76;
  border-radius:14%">
					...
					<li><a href="admin/mlogin.php">Doctor Login</a></li>

				</ul>
			
        		<p style="position:absolute;top:93%;width:100%">Created By Us | <span class="far fa-copyright"></span> 2022 All rights reserved.</p>
