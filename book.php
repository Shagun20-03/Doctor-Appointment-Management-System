...
<body style="background-image:url(images/bookback.jpg);opacity:0.9">
	<div class="header">
		<ul>
			<li style="float:left;border-right:none"><a href="ulogin.php">Doctor Appointment Booking System</a></li>
			<li><a href="ulogin.php">Home</a></li>
		</ul>
	</div>
	<form action="book.php" method="post">
	<div class="sucontainer" style="background-image:url(images/bookback.jpg);opacity:1; padding: 12px;
  position: absolute;
  left: 30%;
  right: 30%;
  top: 8%;
