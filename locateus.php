...
<body class="locate_img" style="background-image:url(images/download.jpg);">
	<div class="header" style="background-color:grey">
	<ul style=" list-style-type: none;   margin: 0;   padding: 0;   overflow: hidden;   background-color: #2B4F76;">
			<li style="float:left;border-right:none"><a href="ulogin.php" class="logo">Doctor Appointment Booking System</a></li>
			<li><a href="cover.php">Home</a></li>
		</ul>
	</div>
	<form action="locateus.php" method="post">
	<div class="sucontainer" style="border: 2px solid white;border-collapse: collapse;background: #fffdd0;background-color: #333">
					
			<label><b >Search Doctor</b></label>
			<input type="text" name="doctorname" placeholder="Enter Doctor Name"></input>
			<button type="submit" style="position:center" name="subd" value="Submit">Submit</button><br>
		</ul>
		...
		<option value="" style="color:black"  >Select Town</option>
		</select><br>
